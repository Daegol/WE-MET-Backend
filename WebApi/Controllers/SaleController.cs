...
namespace WebApi.Controllers
{
    ...
    public class SaleController : ControllerBase
    {
        ...
        public SaleController(ISaleService service, IMapper mapper, ICacheManager cache, IAccountService accountService)
        {
            _service = service;
            _mapper = mapper;
            _cache = cache;
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(BaseResponse<IEnumerable<SaleDto>>))]
        public async Task<IActionResult> GetAll()
        {
            var data = _mapper
                .Map<List<Sale>, List<SaleDto>>(await _service.GetAll());
            return Ok(new BaseResponse<IEnumerable<SaleDto>>(data, $"Lista wszystkich sprzedaży"));
        }

        [HttpGet("{id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(BaseResponse<SaleDto>))]
        public async Task<IActionResult> GetOne(int id)
        {
            var data = _mapper
                .Map<Sale, SaleDto>(await _service.Get(id));
            if (data == null)
                throw new ApiException("Sprzedaż nie istnieje") { StatusCode = (int)HttpStatusCode.BadRequest };
            return Ok(new BaseResponse<SaleDto>(data, $"Sprzedaż o numerze id {id}"));
        }

        [HttpGet("getAllWihtFilters")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(BaseResponse<IEnumerable<SaleDto>>))]
        public async Task<IActionResult> GetAllWithFilters([FromQuery] SaleGetWithFilterRequest request)
        {
            var data = _mapper
                .Map<List<Sale>, List<SaleDto>>(await _service.GetAllWithFilters(request));
            return Ok(new BaseResponse<IEnumerable<SaleDto>>(data, $"Lista wszystkich sprzedaży"));
        }

        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(BaseResponse<string>))]
        public async Task<IActionResult> Add([FromBody] SaleRequest request)
        {
            _cache.Clear();
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
            var data = _mapper.Map<SaleRequest, Sale>(request);
            ...
            return Ok(new BaseResponse<string>("Sprzedaż został dodany"));
        }

        [HttpPut]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(BaseResponse<string>))]
        public async Task<IActionResult> Update([FromBody] SaleUpdateRequest request)
        {
            _cache.Clear();
            ...
            var result = await _service.Update(_mapper.Map<SaleUpdateRequest, Sale>(request));
            if (!result)
                throw new ApiException("Coś poszło nie tak. Spróbuj ponownie.") { StatusCode = (int)HttpStatusCode.BadRequest };
            return Ok(new BaseResponse<string>("Sprzedaż został zaaktualizowany"));
        }
        ...
        public async Task<IActionResult> Approve(int id)
        {
            ...
            if (!result)
                throw new ApiException("Coś poszło nie tak. Spróbuj ponownie.") { StatusCode = (int)HttpStatusCode.BadRequest };
            return Ok(new BaseResponse<string>("Sprzedaż został zatwierdzony"));
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (!result)
                throw new ApiException("Coś poszło nie tak. Spróbuj ponownie.") { StatusCode = (int)HttpStatusCode.BadRequest };
            return Ok(new BaseResponse<string>("Sprzedaż został usunięty"));
        }
        ...
        public async Task<IActionResult> GetReport(int id)
        {
            ...
            return File(report, "application/pdf", "sale_report.pdf");
        }

        [HttpGet("getDailyReportEveryone")]
        public async Task<IActionResult> GetDailyReportEveryone([FromQuery] SaleDailyReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
            ...
            return File(report, "application/pdf", "saleDailyReport.pdf");
        }

        [HttpGet("getDailyReportIndividual")]
        public async Task<IActionResult> GetDailyReportIndividual([FromQuery] SaleDailyReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
        ...
        public async Task<IActionResult> GetDailyReportCompany([FromQuery] SaleDailyReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
        ...
        public async Task<IActionResult> GetMonthlyReportEveryone([FromQuery] SaleMonthlyReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
            ...
            return File(report, "application/pdf", "saleMonthlyReport.pdf");
        }

        [HttpGet("getMonthlyReportIndividual")]
        public async Task<IActionResult> GetMonthlyReportIndividual([FromQuery] SaleMonthlyReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
        ...
        public async Task<IActionResult> GetMonthlyReportCompany([FromQuery] SaleMonthlyReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
        ...
        public async Task<IActionResult> GetCustomReportEveryone([FromQuery] SaleCustomReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
            ...
            return File(report, "application/pdf", "saleCustomReport.pdf");
        }

        [HttpGet("getCustomReportIndividual")]
        public async Task<IActionResult> GetCustomReportIndividual([FromQuery] SaleCustomReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
        ...
        public async Task<IActionResult> GetCustomReportCompany([FromQuery] SaleCustomReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
        ...
        public async Task<IActionResult> GetClientReport([FromQuery] SaleClientReportRequest request)
        {
            var userId = User.FindFirstValue("uid");
            var currentUser = await _accountService.GetOneUser(int.Parse(userId));
            ...
            return File(report, "application/pdf", "saleClientReport.pdf");
        }
    }
}
